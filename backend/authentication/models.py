...
class Support(models.Model):
    supporter_type = models.ForeignKey("SupportEntityType", on_delete=models.CASCADE, related_name='support_set_supporter')
    supporter_entity = models.IntegerField(null=True)
    supported_type = models.ForeignKey("SupportEntityType", on_delete=models.CASCADE, related_name='support_set_supported')
